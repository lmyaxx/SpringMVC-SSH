                        ...
                        <div class="form-three widget-shadow">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" id="username" name="username" placeholder="\${user name}" style="width:200px;">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8"><textarea name="address" id="address" cols="50" rows="4" class="form-control1" style="height: 100px"></textarea></div>
                                </div>
                                <div class="form-group">
