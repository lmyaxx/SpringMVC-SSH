...
<html>
  ...
  <body style="text-align:center;">
  	...
  	<tr>
  	<td style="height:40%"><div class="font-black" style="text-align:center;font-size:48px;width:100%;height:20%;">忘记密码了？</div></td>
  	</tr>
  	<tr style="height:40%"><td><div class="font-black" style="text-align:center;font-size:36px;width:100%;height:20%;">请与经理联系修改密码。</div><br/><hr/><br/></td></tr>
