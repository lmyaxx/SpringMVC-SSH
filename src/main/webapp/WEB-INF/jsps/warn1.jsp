...
<html>
  ...
  <body style="text-align:center;">
  	...
  	<tr>
  	<td style="height:40%"><div class="font-green" style="text-align:center;font-size:48px;width:100%;height:20%;">提示</div></td>
  	</tr>
  	<tr style="height:40%"><td><div class="font-black" style="text-align:center;font-size:36px;width:100%;height:20%;"">${warnInfo}</div><br/><hr/><br/></td></tr>
	...
	function fun() { 
		...
		i--; 
  	  	...
  	  	<form id="fm" method="post" action="${ pageContext.request.contextPath }/login" target="_top">
  		<input type="hidden" name="method" value="jumpToMain">
  	</form>
  </body>
</html>
