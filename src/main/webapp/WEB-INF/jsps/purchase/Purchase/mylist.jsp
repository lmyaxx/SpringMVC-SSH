...
<BODY>
	...
	<div style="width:100%;height:100%;">
			<table  id="dg" class="easyui-datagrid" title="My Purchase Lists" style="width:100%;height:100%"
				data-options="
					singleSelect: true,
					fitColumns:true,
					rownumbers:true,
			...
			<THEAD>
				...
				<TR>
					...
					<TD><a class="easyui-linkbutton button-grayish" href="${pageContext.request.contextPath }/DetailPurchaseList/getDetailPurchaseListUpdatePage?purchaseId=${Purchase.id}">详情</a></TD>
				</TR>
				</c:forEach>
