...
<FORM id="customerForm" name="customerForm" style="width:100%;height:100%;"
    ...
    我的订单进入取值：myList
    --%>
    <input name="method" type="hidden" value="buyListory">
    ...
    <div style="width:100%;height:100%;">
        ...
        >
            ...
            <tr>
                ...
                <th data-options="field:'saler',width:80" align="center">客户</th>
                <th data-options="field:'customer',width:80" align="center"  sortable="true">销售员</th>
