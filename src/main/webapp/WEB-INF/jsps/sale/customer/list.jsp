...
<BODY>
	<FORM style="width:100%;height:100%;" id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/customer/findCustomerByName"
		method=post>
		...
		<table id="dg" class="easyui-datagrid" title="Customer Infomation" style="width:100%;height:100%;"
			...
			<THEAD>
				<TR>
					...
					<TH data-options="field:'customerstate',width:60" align="center" sortable="true">客户状态</TH>
					<TH data-options="field:'func',width:200" align="center">操作</TH>
				</TR>
			</THEAD>
			<TBODY>
				...
				<TR>
					...
					<TD>
					<a class="easyui-linkbutton button-grayish" href="/customer/editCustomer?id=${customer.id}">修改</a>
					&nbsp;&nbsp;
					<a class="easyui-linkbutton button-grayish" href="${pageContext.request.contextPath }/sale/getMyBuyHistory?customerId=${customer.id}">购买历史</a>
					</TD>
				</TR>
