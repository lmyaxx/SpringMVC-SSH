				...
				<div class="layui-card-body">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<INPUT style="width:20%;height:30px" value="${customer.name}" id=sChannel2 class="easyui-textbox" maxLength=50 name="name" data-options="editable:false,lprompt:'Name'">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">客户级别</label>
						<div class="layui-input-block">
							<select style="width:15%;height:30px" class="easyui-combobox" name="vip" data-options="editable:false,required:true">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<INPUT class="easyui-textbox" id="phone" data-options="prompt:'Phone'"
								   style="width:20%;height:30px" maxLength=50 name="phone" value="${customer.phone }">
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<INPUT class="easyui-textbox" id="addr" data-options="prompt:'Address'"
								   style="width:90%;height:30px" maxLength=50 name="addr" value="${customer.addr }">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">联系地址</label>
						<div class="layui-input-block">
							<INPUT class="easyui-textbox" id="email" data-options="prompt:'Email'"
								   style="width:90%;height:30px" maxLength=50 name="email" value="${customer.email }">
						</div>
					</div>
					<div class="layui-form-item" style="text-align: right;padding-right: 10%!important;">
						<a class="layui-btn layui-bg-green" href ="javascript:void(0);" onclick ="check()" id=sButton2 name=sButton2>保存</a>
					</div>
				</div>
			</div>
		</div>
